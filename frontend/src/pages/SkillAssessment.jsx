        ...
        return (
            <main className="page-shell">
                <div className="page-head">
                    ...
                    <p>
                        We analysed your answers and created a path around the
                        areas you need most.
                    </p>
                </div>
                    ...
                    <div className="panel">
                        ...
                        <div className="topic-list">
                            {questions.map((question) => {
                                const needsWork = weakAreas.includes(
                                    question.topic
                                );
                        ...
                        <div className="button-row">
                            <button
                                ...
                                onClick={() =>
                                    navigate(
                                        `/roadmap?skill=${encodeURIComponent(skill)}`
                                    )
                                }
                            >
    ...
    return (
        <main className="page-shell">
            <div className="page-head">
                ...
                <p>
                    Answer from what you know now. Your score controls the
